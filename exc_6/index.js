...
function keyboardDigitClickHandler(digit) {
  ...
  userDigits[currentUserDigitIndex]= digit //EXC_6 adding the new values to the array, before this line was written, the function changed only the text but didn't changed the array.
